	...
	<tbody>
      ...
      <tr>
		...
		<tr>
			<th>글쓴이</th>
			<td>
				<input type="text" name="bo_writer" value="${board.bo_no}" >
			</td>
		</tr>
		<tr>
			<th>패스워드</th>
			<td>
				<input type="password" name="bo_passwd" value="${board.bo_title}" >
			</td>
		</tr>
		<tr>
			<th>이메일</th>
		...
		<tr>
			<th>내용</th>
			<td><textarea row="10" cols="60" name="bo_content" >${board.bo_content}</textarea></td>
		</tr>
		</c:if>
		<c:if test="${empty board}">
		<tr>
